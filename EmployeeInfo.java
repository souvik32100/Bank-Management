...
{
	private JLabel lb1,lb2,lb3,lb4,lb5,imgLabel;
	...
	public EmployeeInfo(EmployeeHome ch)
	{
		...
		bt1.setBounds(240,380,80,30);
		bt1.addActionListener(this);
		panel.add(bt1);
		
		bt2=new JButton("Logout");
		bt2.setBounds(380,380,80,30);
		bt2.addActionListener(this);
		panel.add(bt2);

		bt4=new JButton("Delete");
		bt4.setBounds(520,380,80,30);
	...
	public void findInfo(String id)
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				lb2.setText("Phone Number:  "+"+880"+phoneNumber);
